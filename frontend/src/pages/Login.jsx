          ...
          <div className="w-[380px] backdrop-blur-xl bg-white/60 shadow-2xl rounded-3xl p-8 border border-white/40">
            ...
            <div className="mb-6 relative">
              ...
              <div className="relative">
                ...
                />
                <span className="material-symbols-rounded absolute left-3 top-3.5 text-gray-400">
                  mail
                </span>
              </div>
            </div>
            <div className="mb-6 relative">
              ...
              <div className="relative mb-6">
                ...
                <span className="material-symbols-rounded absolute right-3 top-3.5 text-gray-400">
                  visibility_off
                </span>
              </div>
            </div>
            <button
              type="submit"
              className="w-full py-3 rounded-xl bg-gradient-to-r from-gray-800 to-black text-white font-medium shadow-lg hover:opacity-90 transition duration-200"
            >
              Login
            </button>
          </div>
